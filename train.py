...
def train(experiment_name: str, config: dict, wg: WindowGenerator) -> Tuple[Model, pd.DataFrame]:
    """Creates, traines and evaluates a model using the splits generated by the WindowGenerator

    Args:
        experiment_name (str): Name of the experiment
        config (dict): Configuration dictonary.add()
        wg (WindowGenerator): Window Generator for the evaluation scheme.add()

    Returns:
        Tuple[Model, pd.DataFrame]: Returns the trained model and the training logs.
    """
    # Setup config
...
def evaluation(
    ...
    """Performs the evaluation based on the prediction and target values. Returns values for both
    the prediction and the benchmark."""
